...
export default function Login() {
    ...
    async function enviaLogin(data: Inputs) {
        ...
        try {
          ...
          if (response.status === 200) {
            ...
            console.log("Dados recebidos do backend:", dados) // Debug para ver se tem admin
            ...
            logaCliente({
              ...
              cidade: dados.cidade,
              admin: dados.admin || false // Garantir que admin seja boolean
            })
            
            localStorage.setItem("clienteKey", dados.id)
            
            if (dados.admin) {
              toast.success(`Bem-vindo, Admin ${dados.nome}!`)
              navigate("/admin")
            } else {
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" 
                           onSubmit={handleSubmit(enviaLogin)} >
                            <div>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                ...
                                <Link to="/cadastro" className="font-medium text-primary-600 hover:underline dark:text-primary-500 ml-1">
                                    Cadastre-se
                                </Link>
                            </p>
                        </form>
